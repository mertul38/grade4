...
void Scene::forwardRenderingPipeline(Camera *camera)
{
    ...
    for (Mesh *mesh : meshes)
    {
        ...
        transformVerticesToWorld(mesh);

        // 2. Transform vertices to camera space
        transformVerticesToCamera(mesh, camera);

        // 3. Apply projection
        projectVertices(mesh, camera);

        // 4. Clip triangles
        clipTriangles(mesh);

        // 5. Map to viewport
        mapToViewport(mesh, camera);

        // 6. Rasterize triangles
        rasterizeTriangles(mesh, camera);
    }
}
...
// 2. Transform vertices to camera space
void Scene::transformVerticesToCamera(Mesh *mesh, Camera *camera)
{
    // TODO: Use the camera's position, gaze, and up vectors to transform vertices
}

// 3. Apply projection
void Scene::projectVertices(Mesh *mesh, Camera *camera)
{
    // TODO: Implement perspective or orthographic projection
}

// 4. Clip triangles
void Scene::clipTriangles(Mesh *mesh)
{
    // TODO: Clip triangles that lie outside the view volume
}

// 5. Map to viewport
void Scene::mapToViewport(Mesh *mesh, Camera *camera)
{
    // TODO: Map clip space coordinates to screen space
}

// 6. Rasterize triangles
void Scene::rasterizeTriangles(Mesh *mesh, Camera *camera)
{
    // TODO: Implement rasterization using wireframe or solid mode
}

// Utility for depth buffering (optional)
void Scene::updateDepthBuffer(int x, int y, float depth, Color color)
{
    // TODO: Update depth buffer to ensure correct rendering of overlapping objects
}
